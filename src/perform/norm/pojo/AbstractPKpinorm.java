...
/**
 * AbstractPKpinorm entity provides the base persistence definition of the
...
public abstract class AbstractPKpinorm implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractPKpinorm(String name, String target, String score,
			String rule, String pdpname) {
		this.name = name;
		this.target = target;
		this.score = score;
		this.rule = rule;
