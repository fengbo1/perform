...
public class KPIList_mang {
	...
	public List<PKpinorm> getList() {
		return list;
	}
	public void setList(List<PKpinorm> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from PKpinorm as kp where kp.id>0";
			hql +=" order by kp.id";
