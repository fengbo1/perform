...
/**
 * AbstractPPosition entity provides the base persistence definition of the PPosition entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractPPosition  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractPPosition() {
    }

    
    /** full constructor */
    public AbstractPPosition(String name, String chu, String tuan, String kpinorm, String kpinormprop, String kpirater, String ktinorm, String ktinormprop, String ktirater, String kcinorm, String kcinormprop, String kcirater, String kbinorm, String kbinormprop, String kbirater, Double kpiprop, Double ktiprop, Double kciprop, Double kbiprop) {
        this.name = name;
        this.chu = chu;
        this.tuan = tuan;
