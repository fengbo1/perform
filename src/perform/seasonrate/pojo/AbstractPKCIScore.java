...
/**
 * AbstractPKCIScore entity provides the base persistence definition of the PKCIScore entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractPKCIScore  implements java.io.Serializable {
    ...
    public Integer getKcinumber() {
        return this.kcinumber;
    }
    
    public void setKcinumber(Integer kcinumber) {
        this.kcinumber = kcinumber;
    }
