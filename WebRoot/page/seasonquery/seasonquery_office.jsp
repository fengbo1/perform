...
$('#zu').attr('value',x[3].value);
	 ...
	 function express()
		{
			...
			chu=encodeURI(chu);
			window.location = "<%=path%>/exportpscore.action?type=office&year="+year+"&season="+season+"&chu="+chu+"&tuan="+tuan+"&zu="+zu;
		}
 </script>
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  <form action="<%=path%>/seasonquery_office.action" method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td  width="80px"  align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>关键业绩指标</p><a href="<%=path%>/seasonquery_office.action?sorttype=1&rater=${newnumber}&tuan=${tuan}&zu=${zu}&name=${name}&zhuan=1" style="color:purple;">KPI</a>
								</div></td>	
							<td  width="80px"  align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>关键任务指标</p><a href="<%=path%>/seasonquery_office.action?sorttype=2&rater=${newnumber}&tuan=${tuan}&zu=${zu}&name=${name}&zhuan=1" style="color:purple;">KTI</a>
								</div></td>	
							<td  width="80px"  align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>关键行为指标</p><a href="<%=path%>/seasonquery_office.action?sorttype=3&rater=${newnumber}&tuan=${tuan}&zu=${zu}&name=${name}&zhuan=1" style="color:purple;">KBI</a>
								</div></td>
							<td  width="80px"  align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>关键胜任力指标</p><a href="<%=path%>/seasonquery_office.action?sorttype=4&rater=${newnumber}&tuan=${tuan}&zu=${zu}&name=${name}&zhuan=1" style="color:purple;">KCI</a>
								</div></td>	
							<td  width="80px"  align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>季度总分</p><a href="<%=path%>/seasonquery_office.action?sorttype=5&rater=${newnumber}&tuan=${tuan}&zu=${zu}&name=${name}&zhuan=1" style="color:purple;">SUM</a>
								</div></td>	
							<td  width="80px"  align="center" valign="middle" nowrap
								bordercolor=none><div align="center">
									<p>得分详情</p>
