						...
						<tr  >
							<td colspan="13" height="10px">
								...
								<select id="chu" name="chu" style="width: 150px" onchange="gettuan()">
										...
										<c:if test="${paixus=='1'||paixus=='2'}">
										<option value="生产管理处">生产管理处</option>
										<option value="研发支持一处">研发支持一处</option>
										<option value="专业处理一处">专业处理一处</option>
										<option value="合规与监督一处">合规与监督一处</option>
										
										</c:if>
										<c:if test="${paixus=='1'||paixus=='3'}">
										<option value="通用业务一处">通用业务一处</option>
										<option value="远程支持处">远程支持处</option>
										
										</c:if>
										<c:if test="${paixus=='1'||paixus=='4'}">
										<option value="综合与生产管理处">综合与生产管理处</option>
										<option value="合规与监督二处">合规与监督二处</option>
										<option value="通用业务二处">通用业务二处</option>
										<option value="专业处理二处">专业处理二处</option>
										<option value="研发支持二处">研发支持二处</option>
										</c:if>
										<c:if test="${paixus=='1'||paixus=='5'}">
										<option value="物业服务处">物业服务处</option>
										<option value="安保及基础设施运维处">安保及基础设施运维处</option>
										</c:if>
								</select>				
								团队
