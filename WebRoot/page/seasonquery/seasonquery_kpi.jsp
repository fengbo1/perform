...
$('#zu').attr('value',x[5].value);
	 ...
	 function express()
		{
			...
			window.location = "<%=path%>/exportpscore.action?type=kpi&year="+year+"&season="+season+"&chu="+chu+"&tuan="+tuan+"&zu="+zu;
		}
 </script>
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  <form action="<%=path%>/seasonquery_kpi.action" method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						cellspacing="2" border: 0px;">
						<tr>
							<td
								style="color: #1778C2; padding-top: 0px; padding-bottom: 5px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="8" align="center" bordercolor="#FFFFFF"><b>员工季度KPI指标得分</b>
							</td>
						</tr>
						<tr  >
