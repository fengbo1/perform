...
// var carr=document.getElementsByName("category");
 brbrbr(); 
 var kpinorm=document.getElementById("kpinorm").value;
 document.getElementById(kpinorm).checked=true; 	
 });
 
function fanhui()
{
     var posid=document.getElementById("posid").value;
     window.location = "<%=path%>/posmodifykpireturn.action?posid="+posid;
}
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  ${daohang}
  <form action="posmodifykpi_mang.action" method="post" name="fm1">
					...
					<tr class="btbj" id="hang" style="height:25px">
								...
								<td width="100px" height="25" align="center" valign="middle" nowrap><div
										align="center"><input id="${kp.id}" name="category" type="radio" value="${kp.id}"></div></td>				
				     </tr>
					</c:forEach>
						</table>
			               </div>  
    			...
    			<td colspan="8" class="as">
    			   <div align="center">
    				...
    				<input style="width: 100px" type="button" onclick="fanhui()" value="返回" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   			<input id="posid" type="hidden" name="posid" value="${id}"/>
		   			<input id="kpinorm" type="hidden" name="kpinorm" value="${kpinorm}"/>
		   			</div>	
    			</td>
