...
function tuanidtonamemodify(id)
{
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  ${daohang}
   <form action="<%=path%>/poszxlist.action" method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						cellspacing="2" >
						<tr>
							<td
								style="color: #1778C2; padding-top: 15px; padding-bottom: 15px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="12" align="center" bordercolor="#FFFFFF"><b>中心岗位信息表</b>
							</td>
						</tr>
						<tr>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<div align="center">
								<a	href="<%=path%>/poszxlist.action?city=${city}&chu=${chu}&tuan=${tuan}&currentPage=${previousPage}&newnumber=${newnumber}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/poszxlist.action?city=${city}&chu=${chu}&tuan=${tuan}&currentPage=${nextPage}&newnumber=${newnumber}"
