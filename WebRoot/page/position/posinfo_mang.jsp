   ...
   <form action="<%=path%>/poslist_mang.action" method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<div align="center">
								<a	href="<%=path%>/poslist_mang.action?city=${city}&chu=${chu}&tuan=${tuan}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/poslist_mang.action?city=${city}&chu=${chu}&tuan=${tuan}&currentPage=${nextPage}"
