					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr height="50px" class="表格表头背景1" id="hang">
						  ...
						  <c:if test="${authoR=='R'}">
							...
							<div align="center">
								<a	href="<%=path%>/ktilist_mang.action?city=${city}&chu=${chu}&tuan=${tuan}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/ktilist_mang.action?city=${city}&chu=${chu}&tuan=${tuan}&currentPage=${nextPage}"
